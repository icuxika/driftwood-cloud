package com.icuxika.authorization.config.source;
...
public class JwtUtils {
    ...
    public static org.springframework.security.oauth2.jwt.JwtClaimsSet.Builder idTokenClaims(RegisteredClient registeredClient, String issuer, String subject, String nonce) {
        Instant issuedAt = Instant.now();
